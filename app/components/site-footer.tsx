    ...
    <footer className="site-footer">
      <div className="shell footer-top">
        ...
        <div className="footer-links">
          ...
          <div><b>CONTACT</b><a href="tel:07043044340">070-4304-4340</a><a href="mailto:jjhun65@hanmail.net">jjhun65@hanmail.net</a><span>부산광역시 부산진구 신천대로50번길 62, 우성빌딩 4층</span></div>
        </div>
      </div>
      <div className="shell footer-bottom">
        <p>(주)싱글 · 대표 정지훈 · 사업자등록번호 744-88-01446</p>
