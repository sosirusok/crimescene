(() => {
  ...
  function guidePage() {
    return `${header("guide")}<main id="main-content">${pageTitle("이용 안내","예약부터 플레이까지","처음 방문하셔도 순서대로 안내해 드립니다.")}<section class="section guide-overview"><div><p>크라임씬플레이란?</p><h2>모든 참가자가 사건 속 인물이 되는 추리게임입니다.</h2></div><span>탈출이 목표가 아닙니다. 각자 맡은 배역으로 현장을 조사하고 증거를 모은 뒤 서로의 진술을 검증해 용의자 중 범인을 찾습니다.</span></section><section class="section guide-steps"><article><span>1</span><div><h3>사건과 회차 예약</h3><p>실시간 예약표에서 날짜, 사건, 시간을 선택합니다. 1~3명은 오픈룸으로 예약합니다.</p></div></article><article><span>2</span><div><h3>${state.settings.arrivalMinutes}분 전 도착</h3><p>예약자 이름을 말씀해 주시면 배역 배정과 게임 안내를 시작합니다.</p></div></article><article><span>3</span><div><h3>배역과 개인 정보 확인</h3><p>본인이 맡은 인물의 관계와 사건 당시 상황을 확인합니다.</p></div></article><article><span>4</span><div><h3>현장 조사와 대화</h3><p>공간과 소품에서 단서를 찾고, 서로의 진술을 비교합니다.</p></div></article><article><span>5</span><div><h3>범인 지목과 해설</h3><p>최종 추리를 제출한 뒤 사건의 전말과 각 인물의 이야기를 확인합니다.</p></div></article></section><section class="section open-room-guide"><header><p>오픈룸 안내</p><h2>적은 인원도 같은 회차의 다른 팀과 함께 예약할 수 있습니다.</h2></header><div><article><strong>1~3명</strong><p>오픈룸으로 자동 예약됩니다. 같이 플레이할 분들이 확인할 간단한 소개를 남겨 주세요.</p></article><article><strong>4명 이상</strong><p>예약한 인원끼리만 플레이할지, 남은 자리를 오픈룸으로 열지 선택할 수 있습니다.</p></article><article><strong>진행 기준</strong><p>전체 인원이 4명 이상 모이면 게임을 진행할 수 있습니다. 예약표에 상태가 표시됩니다.</p></article></div></section><section class="section guide-notes"><header><p>방문 전 확인</p><h2>원활한 진행을 위한 안내</h2></header><ul><li><strong>시간</strong><span>게임 시작 후에는 배역 설명과 진행 흐름 때문에 중도 입장이 어렵습니다.</span></li><li><strong>내용 보호</strong><span>다음 참가자를 위해 사건의 정답과 핵심 단서는 외부에 공개하지 말아 주세요.</span></li><li><strong>예약 정보</strong><span>휴대폰 번호를 잘못 입력하면 예약 확인과 운영 안내가 어려울 수 있습니다.</span></li><li><strong>취소</strong><span>이용 ${state.settings.cancellationCutoffHours}시간 전까지 온라인 취소가 가능합니다. 이용 당일 고객 사유 취소와 무단 불참은 환불되지 않습니다.</span></li></ul></section></main>${footer()}`;
  }
  ...
  function faqPage() {
    const faqs=[
      ...
      ["당일에 예약을 취소하면 환불되나요?","이용 당일 고객 사유 취소와 무단 불참은 환불되지 않습니다. 예약 전 날짜, 시간과 인원을 반드시 확인해 주세요."],
  ...
  function policyPage(kind) {
    ...
    const policies={
      terms:{title:"이용약관",desc:"예약 및 체험 서비스 이용에 관한 기본 조건입니다.",sections:[
        ...
        ["5. 취소와 환불",`이용 ${s.cancellationCutoffHours}시간 전까지 온라인 취소가 가능합니다. 이용 당일 고객 사유 취소와 무단 불참은 환불되지 않으며, 매장 사정 또는 관계 법령상 환불 사유가 있는 경우에는 해당 기준을 우선 적용합니다.`],
        ["6. 콘텐츠 보호","사건의 정답, 핵심 단서와 진행 내용을 외부에 공개해 다른 이용자의 체험을 방해해서는 안 됩니다."],
        ["7. 서비스 변경","시설 점검, 안전 또는 불가피한 운영 사유가 발생하면 매장은 일정을 변경하거나 예약을 취소할 수 있으며, 유료 결제가 완료된 경우 해당 금액을 환급합니다."],
        ["8. 문의",`${s.phone} / ${s.email}`],
      ]},
      ...
      refunds:{title:"취소 및 환불 안내",desc:"예약 전 반드시 확인해야 하는 취소 및 환불 기준입니다.",sections:[
        ["1. 온라인 취소",`이용 시작 ${s.cancellationCutoffHours}시간 전까지 예약 확인·취소 화면에서 직접 취소할 수 있습니다.`],
        ["2. 이용 당일 취소","이용 당일 고객 사유로 예약을 취소하거나 연락 없이 방문하지 않은 경우에는 환불되지 않습니다. 예약 전 날짜, 시작 시간과 인원을 반드시 확인해 주세요."],
        ["3. 취소 가능 시간이 지난 경우",`이용 시작 ${s.cancellationCutoffHours}시간 전부터는 온라인 취소가 제한됩니다. 변경이나 취소가 필요한 경우 ${s.phone}로 문의해 주세요.`],
        ["4. 예약 변경","사건, 날짜, 시간 또는 인원 변경이 필요한 경우 매장으로 문의해 주세요. 변경할 회차의 잔여 인원에 따라 변경이 어려울 수 있습니다."],
        ["5. 지각과 미방문","지각하면 전체 이용 시간이 줄어들 수 있으며 시작 후 입장이 제한될 수 있습니다. 이용 당일 무단 불참은 환불되지 않습니다."],
        ["6. 매장 사유 취소","시설 또는 운영상의 사유로 예약한 서비스를 제공하지 못하는 경우 일정 변경 또는 결제 금액 전액 환급을 안내합니다."],
        ["7. 예외 기준","매장 사정 또는 관계 법령상 별도의 환불 사유가 인정되는 경우에는 해당 기준을 우선 적용합니다."],
        ["8. 문의",`${s.phone} / ${s.email}`],
      ]},
    };
