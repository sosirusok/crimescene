  ...
  function policyPage(kind) {
    ...
    const policies={
      ...
      privacy:{title:"개인정보처리방침",desc:"예약과 문의 처리에 필요한 정보만 수집하고 안전하게 관리합니다.",sections:[
        ...
        ["3. 보유 기간","예약 계약 및 취소 관련 기록과 결제·서비스 제공 기록은 관계 법령에 따라 필요한 기간 동안 보관합니다. 소비자 불만 또는 분쟁 처리 기록은 3년간 보관하며, 법령상 의무가 없는 정보는 이용 목적이 끝난 뒤 지체 없이 파기합니다."],
